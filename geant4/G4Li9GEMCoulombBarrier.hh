...
//
//
// $Id: G4Li9GEMCoulombBarrier.hh,v 1.4 2009/09/15 12:54:16 vnivanch Exp $
...
class G4Li9GEMCoulombBarrier : public G4GEMCoulombBarrier
{
public:
//JMQ 200709
//  G4Li9GEMCoulombBarrier() : G4GEMCoulombBarrierHE(9,3) {};
  G4Li9GEMCoulombBarrier() : G4GEMCoulombBarrier(9,3) {};
