...
//
//
// $Id: G4Li7GEMCoulombBarrier.hh,v 1.4 2009/09/15 12:54:16 vnivanch Exp $
...
class G4Li7GEMCoulombBarrier : public G4GEMCoulombBarrier
{
public:
//JMQ 200709
//  G4Li7GEMCoulombBarrier() : G4GEMCoulombBarrierHE(7,3) {};
  G4Li7GEMCoulombBarrier() : G4GEMCoulombBarrier(7,3) {};
