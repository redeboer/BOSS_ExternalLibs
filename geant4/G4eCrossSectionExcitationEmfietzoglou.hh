...
#include "G4Track.hh"
 ...
 class G4eCrossSectionExcitationEmfietzoglou
 {
  public:

   G4eCrossSectionExcitationEmfietzoglou();
 
   virtual ~G4eCrossSectionExcitationEmfietzoglou();
 ...
 private:
   ...
   G4double PartialCrossSection(G4double k, G4int excitationLevel);
