...
//
//
// $Id: G4Mg26GEMCoulombBarrier.hh,v 1.4 2009/09/15 12:54:16 vnivanch Exp $
...
class G4Mg26GEMCoulombBarrier : public G4GEMCoulombBarrier
{
public:
//JMQ 200709
//  G4Mg26GEMCoulombBarrier() : G4GEMCoulombBarrierHE(26,12) {};
 G4Mg26GEMCoulombBarrier() : G4GEMCoulombBarrier(26,12) {};
