...
//
//
// $Id: G4B12GEMCoulombBarrier.hh,v 1.4 2009/09/15 12:54:16 vnivanch Exp $
...
class G4B12GEMCoulombBarrier : public G4GEMCoulombBarrier
{
public:
//JMQ 200709
//  G4B12GEMCoulombBarrier() : G4GEMCoulombBarrierHE(8,5) {};
  G4B12GEMCoulombBarrier() : G4GEMCoulombBarrier(12,5) {};
