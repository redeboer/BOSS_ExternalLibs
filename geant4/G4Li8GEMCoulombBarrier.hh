...
//
//
// $Id: G4Li8GEMCoulombBarrier.hh,v 1.4 2009/09/15 12:54:16 vnivanch Exp $
...
class G4Li8GEMCoulombBarrier : public G4GEMCoulombBarrier
{
public:
//JMQ 200709
//  G4Li8GEMCoulombBarrier() : G4GEMCoulombBarrierHE(8,3) {};
  G4Li8GEMCoulombBarrier() : G4GEMCoulombBarrier(8,3) {};
