...
TRadSpline3::TRadSpline3(const char *title,
		   double x[], double y[], int n, const char *opt,
		   double valbeg, double valend) :
...
TRadSpline3::TRadSpline3(const char *title,
			 double xmin, double xmax,
			 double (*func)(const double&), int n, const char *opt,
			 double valbeg, double valend) :
  TRadSpline(title,(xmax-xmin)/(n-1), xmin, xmax, n, true),
  fValBeg(valbeg), fValEnd(valend),
  fBegCond(0), fEndCond(0)
...
void TRadSpline3::SetCond(const char *opt)
{
  //
...
//____________________________________________________________________________
void TRadSpline3::SaveAs(const char *filename) const
{
...
TRadSpline5::TRadSpline5(const char *title,
		   ...
		   const char *opt, double b1, double e1,
		   double b2, double e2) :
  TRadSpline(title,-1, x[0], x[n-1], n, false)
{
  //
...
TRadSpline5::TRadSpline5(const char *title,
			 double xmin, double xmax,
			 double (*func)(const double&), int n,
			 const char *opt, double b1, double e1,
			 double b2, double e2) :
  TRadSpline(title,(xmax-xmin)/(n-1), xmin, xmax, n, true)
{
...
void TRadSpline5::BoundaryConditions(const char *opt,int &beg,int &end,
...
//____________________________________________________________________________
void TRadSpline5::SetBoundaries(double b1, double e1, double b2, double e2,
...
//____________________________________________________________________________
void TRadSpline5::SaveAs(const char *filename) const
{
  // write this spline as a C++ function that can be executed without ROOT
  // the name of the function is the name of the file up to the "." if any
