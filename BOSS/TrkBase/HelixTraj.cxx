// $Id: HelixTraj.cxx,v 1.4 2010/03/25 09:56:26 zhangy Exp $
...
void
HelixTraj::getInfo(double fltLen, HepPoint3D& pos, Hep3Vector& dir,
...
void
HelixTraj::getInfo( double fltLen, HepPoint3D& pos, Hep3Vector& dir ) const
{
  //  double ang = angle(fltLen);
  double cDip = cosDip();
  double sDip = tanDip() * cDip;
...
void
HelixTraj::paramFunc(const HepPoint3D& oldpoint,const HepPoint3D& newpoint,
