...
// 	$Id: TrkExpectedHotSet.cxx,v 1.1.1.1 2005/04/21 06:01:42 zhangy Exp $
//
// Description:
...
// This Class's Header --
//-----------------------
#include "TrkBase/TrkExpectedHotSet.h"
...
bool 
TrkExpectedHotSet::isMdc() const {
  return _elemId.sysInd() == TrkDetElemId::mdc;
}
