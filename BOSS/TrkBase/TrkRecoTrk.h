...
//      $Id: TrkRecoTrk.h,v 1.4 2008/04/01 03:13:19 zhangy Exp $
//
// Description:
...
//class TrkRecoTrk : public ContainedObject {//yzhang
class TrkRecoTrk {
public:
...
//typedef ObjectVector<TrkRecoTrk> TrkRecoTrkCol;
