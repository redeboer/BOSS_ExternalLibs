...
void
NeutTraj::getInfo(double fltLen, HepPoint3D& pos, Hep3Vector& dir,
...
void
NeutTraj::getInfo( double fltLen, HepPoint3D& pos, Hep3Vector& dir ) const
{
  //  This could be made much more efficient!!!!!
  pos = position(fltLen);
  dir = direction(fltLen);
...
void
NeutTraj::paramFunc(const HepPoint3D& oldpoint,const HepPoint3D& newpoint,
