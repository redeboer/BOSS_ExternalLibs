...
//      $Id: TrkFundHit.h,v 1.4 2011/02/17 11:53:41 zhangy Exp $
//
// Description:  Abstract base class.  Derived classes describe detector 
//  (Svt & Mdc) hits, used as input to tracking routines.  All 
...
// Class interface //
//class TrkFundHit : public AbsEvtObj {//yzhang temp
//class TrkFundHit {//yzhang delete

class TrkFundHit : public ContainedObject {
