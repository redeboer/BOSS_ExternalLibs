...
// 	$Id: DifComplex.h,v 1.2 2009/12/23 02:59:56 zhangy Exp $
//
// Description:
...
public:
  ...
  inline friend DifComplex fromPolar
...
#include "MdcRecoUtil/DifComplex.icc"
/*del**
inline ostream& operator<<(ostream& o,const DifComplex& c){
  c.print(o);
  return o;
}
 */
