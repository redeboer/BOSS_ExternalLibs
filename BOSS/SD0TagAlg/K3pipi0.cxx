//
//  K3pipi0.cxx is the single D0 tag code to reconstruct D0 or anti-D0 through the final states of
//  K3pipi0 from D0 decays. K3pipi0.cxx was transfered from the Fortran routine "K3pipi0.f"
...
//
//  The orignal Fortran routine "K3pipi0.f" used at the BES-II experiment was coded by G. Rong in 2001.
//
...
void K3pipi0::MTotal(double event,SmartDataPtr<EvtRecTrackCol> evtRecTrkCol, Vint iGood,Vint
