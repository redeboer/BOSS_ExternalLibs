// @(#)root/base:$Name: BesVisLib-00-05-04 $:$Id: BesTView.cxx,v 1.7 2018/11/06 00:35:15 longpx Exp $
...
//______________________________________________________________________________
void BesTView::DefineViewDirection(const Double_t *s, const Double_t *c,
...
//______________________________________________________________________________
void BesTView::SetRange(Double_t x0, Double_t y0, Double_t z0, Double_t x1, Double_t y1, Double_t z1, Int_t flag)
{
   //*-*-*-*-*-*-*-*-*-*-*-*Set 3-D View range*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
   //*-*                    ==================
   //*-*
