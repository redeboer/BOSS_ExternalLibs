// @(#)root/base:$Name: BesVisLib-00-05-04 $:$Id: BesTView.h,v 1.7 2018/11/06 00:35:15 longpx Exp $
...
#ifndef ROOT_BesTView
#define ROOT_BesTView
...
protected:
   ...
   BesTView(const BesTView&); // Not implemented
   BesTView& operator=(const BesTView&); // Not implemented

   void            ResetView(Double_t longitude, Double_t latitude, Double_t psi, Int_t &irep);


public:
   // BesTView status bits
   enum {
      kPerspective  = BIT(6)
   };
...
//--
   ...
   ClassDef(BesTView,2);  //3-D View
};

//      Shortcuts for menus
inline void BesTView::Centered(){Centered3DImages();}
inline void BesTView::Front()   {FrontView();}
inline void BesTView::ShowAxis(){ToggleRulers(); }
inline void BesTView::Side()    {SideView();}
inline void BesTView::Top()     {TopView();}
inline void BesTView::ZoomMove(){ToggleZoom();}
inline void BesTView::Zoom()    {ZoomView();}
inline void BesTView::UnZoom()  {UnzoomView();}
