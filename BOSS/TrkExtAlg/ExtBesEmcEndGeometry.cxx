...
void ExtBesEmcEndGeometry::Exchange(G4int cry1, G4int cry2)
{
  G4ThreeVector v;
  for(G4int i=0;i<8;i++)
  {
...
//subtract the casing      
void ExtBesEmcEndGeometry::ModifyForCasing(G4ThreeVector pos[8], G4int CryNb)
{
...
G4ThreeVector ExtBesEmcEndGeometry::ComputeDimAndPos
