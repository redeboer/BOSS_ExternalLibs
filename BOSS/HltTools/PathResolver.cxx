...
static bool PR_test_exist (const std::string& name, std::string& real_name, PR_file_type file_type)
{
  ...
  //std::cout << "test_file> name=" << name << std::endl;
			 ...
			 std::vector<std::string>& list)
{
          ...
          if ((strcmp ((char*) entry.name, ".") != 0) &&
              ...
              (strncmp ((char*) entry.name, ".nfs", 4) != 0))
            {
              ...
              if (!need_filter ||
                ...
                {
                  std::string& name_entry = list.add ();
  ...
  //std::cout << "scan_dir2> dir_prefix=" << dir_prefix << std::endl;
  ...
  if (dir != 0)
    {
      ...
      //std::cout << "scan_dir3> need_filter=" << need_filter << std::endl;
