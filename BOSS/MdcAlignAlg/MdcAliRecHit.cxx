...
const double MdcAliRecHit::m_df = 10.0;
const double MdcAliRecHit::m_qf = 1.0;

void MdcAliRecHit::setRecHit(HitRefVec::iterator it_hit){
     IMessageSvc *msgSvc;
     Gaudi::svcLocator()->service("MessageSvc", msgSvc);
     MsgStream log(msgSvc, "MdcAliRecHit");
     log << MSG::DEBUG << "MdcAliRecHit::setRecHit()" << endreq;
     ...
     if( 0 == m_lr )   m_resilrInc = -1.0 * m_resiInc;//for recon of pat
...
void MdcAliRecHit::setKalHit(HelixSegRefVec::iterator it_hit){
     ...
     Gaudi::svcLocator()->service("MessageSvc", msgSvc);
     MsgStream log(msgSvc, "MdcAliRecHit");
     log << MSG::DEBUG << "MdcAliRecHit::setKalHit()" << endreq;
