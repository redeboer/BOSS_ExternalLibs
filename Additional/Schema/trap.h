...
/*     const std::string& get_Talpha1() const { */
/*       return m_Talpha1; */
/*     } */
/*     const std::string& get_Talpha2() const { */
/*       return m_Talpha2; */
/*     } */
/*     const std::string& get_thetaCphi() const { */
/*       return m_thetaCphi; */
/*     } */
/*     const std::string& get_thetaSphi() const { */
/*       return m_thetaSphi; */
/*     } */
...
/*     void set_Talpha1( const std::string& Talpha1 ) { */
/*       m_Talpha1 = Talpha1; */
/*     } */
/*     void set_Talpha2( const std::string& Talpha2 ) { */
/*       m_Talpha2 = Talpha2; */
/*     } */
/*     void set_thetaCphi( const std::string& thetaCphi ) { */
/*       m_thetaCphi = thetaCphi; */
/*     } */
/*     void set_thetaSphi( const std::string& thetaSphi ) { */
/*       m_thetaSphi = thetaSphi; */
/*     } */
...
/*     std::string m_Talpha1; */
/*     std::string m_Talpha2; */
/*     std::string m_thetaCphi; */
/*     std::string m_thetaSphi; */
